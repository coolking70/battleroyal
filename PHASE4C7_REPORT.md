...
| 记录内容 | 仅玩家 actor 的事件里程碑、玩家自身结局与自身死亡原因 |
...
死亡原因（仅统计玩家自身 `CHARACTER_DIED` 事件）：
...
3. **中间步骤和高阶完成仍有损耗，但死因不是单一战斗问题。** 15/20 完成目标
   依赖中的中间步骤，9/20 完成最终目标；17 个死亡样本分为衰竭 6、战斗 5、
   禁区侵蚀 6。下一步应优先记录真人在看到“还缺什么/去哪里找”后是否真的按
   路线移动，以及资源管理/禁区压力/遭遇是否打断路线。
...
- 记录只保留玩家 actor 的材料/合成/装备/遭遇/死亡里程碑及自身死亡原因。
