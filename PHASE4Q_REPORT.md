...
15. Full-suite status: `115 files / 1,672 tests passed`. Five existing deterministic AutoPlayer/combat fixtures now use explicit AF3-compatible seeds or a committed Apex route so their original command/lifecycle assertions remain stable; no balance numbers or runtime tuning were changed.
