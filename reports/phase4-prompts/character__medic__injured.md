...
- Face and hair: calm but tired face, practical tied hair or short hair, attentive expression.
- Clothing: worn everyday survival jacket with a compact medical pouch and restrained green-white accents; practical field medic, not a formal white coat.
- Palette: desaturated green, off-white, gray, muted red detail.
- Signature prop: compact first-aid pouch or folded bandage.
- Avoid: sexualized nurse uniform, formal hospital coat, excessive blood, logos, text.

Asset brief:
The same medic character design, clothing, hair, and first-aid pouch as the normal portrait; only lightly injured, tired and dusty, with a small bandage and no severe blood or wounds.

Variant: injured. Keep the entity identity stable across variants.

Technical composition: 768x1024, clear focal subject, no text, no logo, no watermark.

## Negative prompt

text, watermark, logo, signature, extra fingers, extra limbs, deformed hands, duplicate person, cropped head, extreme fisheye, low resolution, blur, UI frame, photo watermark, recognizable commercial IP, artist imitation
